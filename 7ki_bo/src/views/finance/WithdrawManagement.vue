...
import { Settings, ReloadOutline, AddOutline, DownloadOutline, CopyOutline } from '@vicons/ionicons5';
...
const handleBulkProcess = (_selectedRows: WithdrawOrder[]) => {
  showBatchModal();
};

const handleBulkCancel = (_selectedRows: WithdrawOrder[]) => {
  showBatchModal();
};
