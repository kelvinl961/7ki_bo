  ...
  <div class="download-site-view">
    ...
    >
      <n-space vertical :size="16" style="margin: 20px 0">
        ...
        <div>
          <div style="margin-bottom: 8px; font-weight: 500">代理账号 <span style="color: red">*</span></div>
          <n-input
...
const columns: DataTableColumn<Domain>[] = [
  ...
  { 
    title: h('div', { style: 'white-space: nowrap;' }, [
      h('div', {}, '解析说明'),
      h('div', { style: 'font-size: 11px; font-weight: normal; color: #999;' }, '(生效状态和同源)')
    ]) as any,
    key: 'dnsStatus', 
    width: 150,
    render(row: Domain) {
  ...
  { 
    ...
    render(row: Domain) {
      return h('div', { style: 'display: flex; align-items: center; gap: 6px; justify-content: center;' }, [
        ...
        h('span', { style: 'font-size: 12px; color: #999;' }, row.boundAgentId || '无')
      ]);
    }
  },
  { 
