...
function setupAccessGuard(router: Router) {
  router.beforeEach(async (to, from) => {
    ...
    // ✅ PERFORMANCE FIX: Check if access is already checked to avoid blocking navigation
    ...
    // The menu API call happens inside generateAccess, but it's only called once due to isAccessChecked guard
