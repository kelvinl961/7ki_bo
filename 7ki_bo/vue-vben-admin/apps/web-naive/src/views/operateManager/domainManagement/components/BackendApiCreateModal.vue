...
const fetchAvailableDomains = async (cdnProvider: string) => {
  ...
  try {
    ...
    console.log('[BackendApiModal] 🔍 response.data.data:', response.data?.data);
    ...
    if (actualData && actualData.list && Array.isArray(actualData.list)) {
      ...
      console.log('[BackendApiModal] ✅ Found actualData.list:', domainsList.length, 'domains');
    } else if (Array.isArray(actualData)) {
      domainsList = actualData;
      console.log('[BackendApiModal] ✅ Found direct array:', domainsList.length, 'domains');
    } else {
      console.error('[BackendApiModal] ❌ Unexpected response format!');
      console.error('[BackendApiModal] actualData type:', typeof actualData);
      console.error('[BackendApiModal] actualData keys:', Object.keys(actualData || {}));
    }
    ...
    console.log(`[BackendApiModal] ✅ Final: ${uniqueDomains.length} unique domains`, uniqueDomains);
